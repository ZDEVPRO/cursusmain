...
class Product(models.Model):
    ...
    time_button = models.CharField(max_length=15, choices=TIME)
    cost = models.CharField(max_length=15, choices=COST)
    country = models.CharField(max_length=50, choices=COUNTRY)
    language = models.CharField(max_length=50, choices=LANGUAGE)
    views = models.CharField(blank=True, max_length=15, default=0)
    guaranted = models.CharField(blank=True, max_length=200, choices=GUARANTED)
    status = models.CharField(max_length=15, choices=STATUS)
    ...
    @property
    def views_some(self):
        return f"{self.views}" if self.views else 0
