            ...
            options: {
                ...
                scales: {
                    xAxes: [
                        {
                            ...
                            ticks: {
                                display: false, // hide home x-axis line
                                beginAtZero: true
                            },
                            barPercentage: 1.8,
                    ...
                    yAxes: [
                        {
                            gridLines: {
                                drawBorder: false, // hide home y-axis line
                                display: false
                            },
                            ticks: {
                                display: false,
                    ...
                    xAxes: [
                        {
                            ...
                            ticks: {
                                display: true, // false will hide home x-axis line
                                beginAtZero: true,
                                fontFamily: "Roboto, sans-serif",
                                fontColor: "#8a909d",
                                callback: function (value) {
        ...
        options: {
            ...
            scales: {
                xAxes: [
                    {
                        ...
                        ticks: {
                            display: true, // hide home x-axis line
                            beginAtZero: true,
                            fontFamily: "Roboto, sans-serif",
                            fontColor: "#8a909d"
                        }
                ...
                yAxes: [
                    {
                        gridLines: {
                            drawBorder: true, // hide home y-axis line
                            display: true
                        },
                        ticks: {
                            callback: function (value) {
